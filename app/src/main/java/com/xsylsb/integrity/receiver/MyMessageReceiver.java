package com.xsylsb.integrity.receiver;
...
public class MyMessageReceiver extends MessageReceiver {
    ...
    // 消息接收部分的LOG_TAG
    public static final String REC_TAG = "MessageService";
    ...
    public void onNotification(Context context, String title, String summary, Map<String, String> extraMap) {
        ...
        MainApplication.receiveThePush("收到一条推送通知 ： " + title + ", summary:" + summary);
    }
    ...
    protected void onNotificationReceivedInApp(Context context, String title, String summary, Map<String, String> extraMap, int openType, String openActivity, String openUrl) {
        ...
        MainApplication.receiveThePush("onNotificationReceivedInApp ： " + " : " + title + " : " + summary);
    }
    ...
    public void onMessage(Context context, CPushMessage cPushMessage) {
        ...
        MainApplication.receiveThePush(cPushMessage.getTitle() + ", content:" + cPushMessage.getContent());
    }
    ...
    public void onNotificationOpened(Context context, String title, String summary, String extraMap) {
        ...
        MainApplication.receiveThePush("onNotificationOpened ： " + " : " + title + " : " + summary + " : " + extraMap);
    }
    ...
    public void onNotificationRemoved(Context context, String messageId) {
        ...
        MainApplication.receiveThePush("onNotificationRemoved ： " + messageId);
    }
    ...
    protected void onNotificationClickedWithNoAction(Context context, String title, String summary, String extraMap) {
        ...
        MainApplication.receiveThePush("onNotificationClickedWithNoAction ： " + " : " + title + " : " + summary + " : " + extraMap);
    }
}